...
set DEFAULT_JVM_OPTS="--add-exports=java.desktop/sun.awt.image=ALL-UNNAMED" "--enable-native-access=ALL-UNNAMED" "-Dsun.java2d.uiScale.enabled=true"
